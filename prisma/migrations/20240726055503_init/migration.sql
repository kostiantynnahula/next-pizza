...
-- CreateTable
CREATE TABLE "VerificationConde" (
    "id" SERIAL NOT NULL,
    "userId" INTEGER NOT NULL,
    "code" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "VerificationConde_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "VerificationConde_userId_key" ON "VerificationConde"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "VerificationConde_userId_code_key" ON "VerificationConde"("userId", "code");
...
-- AddForeignKey
ALTER TABLE "VerificationConde" ADD CONSTRAINT "VerificationConde_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
